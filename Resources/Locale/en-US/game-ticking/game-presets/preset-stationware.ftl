...
stationware-you-won = You won! Go wild before the round ends!
stationware-report-score = {$place}. [color=cyan]{$name}[/color] had a score of [color=yellow]{$points}[/color]
