...
challenge-acid-trip = Chemistry created an acid so pure it BURNS THROUGH ALL SKIN! Stay alive!
challenge-keep-the-crown = Punch the person with the crown to steal it. The person with the crown wins.
challenge-put-that-helmet-on = THERE'S A SPACING, PUT THAT FUCKING HELMET ON!
challenge-greytide = Greytide worldwide!
challenge-landmine = Oops! Cargo mixed our soap and bats with landmines and rats! Stay alive!
...
challenge-hide = Oh no! A super duper scary monster called the 'failing monster' will rush upon the arena in exactly 5 seconds, hide!
